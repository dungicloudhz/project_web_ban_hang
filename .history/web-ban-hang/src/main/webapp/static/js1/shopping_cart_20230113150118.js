...
function updateQuantity(productId, quantity) {
  ...
  $.ajax({
    ...
    .done(function (newSubtotal) {
      newSubtotals = newSubtotal.toLocaleString();
      updateSubtotal(newSubtotals, productId);
      updateTotal();
      $(".quantity-cart-item").text(response);
    })
    .fail(function () {});
...
function updateSubtotal(newSubtotals, productId) {
  $("#subtotal" + productId).text(newSubtotals);
}
